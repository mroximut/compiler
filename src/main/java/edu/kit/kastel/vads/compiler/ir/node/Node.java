...
public sealed abstract class Node permits BinaryOperationNode, Block, ConstIntNode, BitwiseNotNode, LogicalNotNode, Phi, ProjNode, ReturnNode, StartNode, BranchNode, JumpNode, UndefNode {
