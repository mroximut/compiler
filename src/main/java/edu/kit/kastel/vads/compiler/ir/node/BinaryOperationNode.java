...
public sealed abstract class BinaryOperationNode extends Node permits AddNode, DivNode, ModNode, MulNode, SubNode, ShlNode, ShrNode,
    LtNode, LeNode, GtNode, GeNode, EqNode, NeNode, BitwiseAndNode, BitwiseXorNode, BitwiseOrNode {
